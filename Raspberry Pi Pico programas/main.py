...
com1 = Easy_comms(uart_id=1, baud_rate=115200, tx=8, rx=9)
com1.start()
...
def plot_time(yp, t, x, y, var=[0,20], vpts=[25,16,40], hpts=[25,55,112]):
...
def send_weight(timer):
    com1.send(str(weight))
weight_timer = Timer()
weight_timer.init(period=1000, mode=Timer.PERIODIC, callback=send_weight)
